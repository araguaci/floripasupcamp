...
<div id="overlay" class="content">
  <div class="inner">
    <div id="box-shadow">
      <h1  class="titulo" style="font-size:30px; color:#000; text-align:center; font-weight:bolder; margin-left: 30px;">FLORIPA SUP CAMP </h1>
    </div>
    <ul id="da-thumbs" class="da-thumbs">
      <li> <a href="http://www.escolasdesurf.org.br"> <img src="apoiadores/logo_aces.jpg" />
        <div><span>ACES</span>
          <p style="padding:5px; color:#FFFFFF;">Associação Catarinense de Especialistas em SUP & SURF. Trabalha na capacitação e orientação de escolas de SURF & SUP de Santa Catarina.</p>
        </div>
        </a> </li>
      ...
      <li> <a href="http://www.floripasurfclub.com"> <img src="apoiadores/floripasurfclub.jpg" />
      ...
      <li> <a href="http://www.mormaii.com.br/"> <img src="apoiadores/mormaii.jpg" />
        <div><span>Mormaii</span>
          <p style="padding:5px; color:#FFFFFF;"> Pioneira com trinta anos de inovações para esportes outdoor. Parceria em equipamentos e produtos de saúde.</p>
        </div>
        </a> </li>
    </ul>
    </section>
